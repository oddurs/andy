...
Acceptance criteria
- [x] andy accounts for its own cache under its own name
- [x] "other in ~/.cache" no longer moves because andy ran
- [x] Two consecutive scans of the same tree report the same total
